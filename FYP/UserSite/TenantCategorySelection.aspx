<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserSite/TenantHeader.Master" CodeBehind="TenantCategorySelection.aspx.cs" Inherits="FYP.UserSite.TenantCategorySelection" %>
...
<head>
    <title>Tenant Category Selection Page</title>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="container">
            <div class="form-inline">
                ...
                <asp:Button ID="btnManageCategoryPermission" runat="server" Text="Manage Category" OnClick="btnManageCategoryPermission_Click" CssClass="btn btn-secondary ml-auto" />
                <asp:Button ID="btnCreateCategoryPage" runat="server" Text="Create New Category" OnClick="btnCreateCategoryPage_Click" CssClass="btn btn-primary ml-2" />
