<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserSite/Header.Master" CodeBehind="UploadDocument.aspx.cs" Inherits="FYP.UserSite.UploadDocument" %>
...
<body>
    <div class="modal fade" id="notificationModal" tabindex="-1" role="dialog" aria-labelledby="notificationModalLabel" aria-hidden="true">
        ...
        <div id="uploadForm" class="mt-3 needs-validation" style="border-radius: 10px;">
            ...
            <div class="row mt-3">
                <div class="col">
                    <asp:Button ID="btnSaveDocument" runat="server" Text="Save Document" OnClick="btnSaveDocument_Click" CssClass="btn btn-primary" />
