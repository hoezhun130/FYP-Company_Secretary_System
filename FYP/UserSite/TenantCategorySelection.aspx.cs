    ...
    public partial class TenantCategorySelection : System.Web.UI.Page
    {
        ...
        private bool GetFirstLoginStatusFromDatabase(int userId)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT IsFirstLogin FROM TenantUser WHERE TU_ID = @UserId";
        ...
        private void UpdateUserPassword(int userId, string newPassword)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    // Update the Password column in the TenantUser table
                    string updatePasswordQuery = "UPDATE TenantUser SET Password = @Password WHERE TU_ID = @UserId";
        ...
        //    // For simplicity, this example uses SHA-256, which is not recommended for real-world scenarios
        ...
        {
            // Update the IsFirstLogin column in the TenantUser table
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string updateIsFirstLoginQuery = "UPDATE TenantUser SET IsFirstLogin = 0 WHERE TU_ID = @UserId";
            ...
            private void BindDefaultCategories()
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    try
                    {
                        ...
                        string query = @"
                SELECT CategoryID, CategoryName, IconPath, AllowPermission, TU_ID, IsDefault
                FROM Category 
                WHERE (IsDefault = 1 OR (TU_ID IS NOT NULL AND (TU_ID = @UserID OR AllowPermission LIKE @UserName OR AllowPermission IS NULL)))
    ...
    ";
                        ...
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                            {
                                ...
                                var filteredCategories = dt.AsEnumerable().Where(row =>
                                {
                                    ...
                                    int tuId = row["TU_ID"] == DBNull.Value ? -1 : Convert.ToInt32(row["TU_ID"]);
                                    string allowPermission = row["AllowPermission"].ToString();
                                    string userName = GetUserName();

                                    return isDefault || tuId == userID ||
        ...
        private string GetUserNameById(int userID)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT Name FROM TenantUser WHERE TU_ID = @UserID";
        ...
        private string GetUserNameByEmail(string email)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT UserName FROM TenantUser WHERE Email = @Email";
        ...
        private string GetUserDepartmentById(int userID)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT Department FROM TenantUser WHERE TU_ID = @UserID";
        ...
        private string GetUserDepartmentByEmail(string email)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT Department FROM TenantUser WHERE Email = @Email";
        ...
        protected void btnCreateCategoryPage_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TenantCreateCategory.aspx");
        ...
        private int GetExistingCategoriesCount(int userId)
        {
            ...
            {
                string sql = "SELECT COUNT(*) FROM Category WHERE TU_ID = @UserId";
        ...
        private int GetSubscriptionTier(int userId)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                string sql = "SELECT TierName FROM Subscription WHERE TU_ID = @UserId";
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    cmd.Parameters.AddWithValue("@UserId", userId);
        ...
        private void PopulateCategoryDropdownForModal(IEnumerable<DataRow> categories)
        {
            ...
            foreach (DataRow row in categories)
            {
                ...
                if (!isDefault && tuId == currentUserId)
                {
        ...
        {
            Response.Redirect($"TenantSetCategoryPermission.aspx");
        }
