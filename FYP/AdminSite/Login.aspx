                ...
                <div>
                    ...
                    <asp:MultiView ID="multiView" runat="server">
                        ...
                        <asp:View ID="loginView" runat="server">
                            <img src="images/login.png" class="img-fluid mx-auto d-block mb-3" style="max-width: 150px; height: auto; padding-top: 30px;" />
                            <h1 class="text-center">Account Login</h1>
                            <p class="text-center">Please enter the account details.</p>
                            ...
                            <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" CssClass="form-control btn btn-primary btn-block" /><br />
                            <asp:CheckBox ID="chkRememberMe" runat="server" Text="Remember Me" CssClass="form-control form-control-transparent-border border-0" />
                        </asp:View>
                        ...
                        <asp:View ID="twoFactorView" runat="server">
                            ...
                            <p class="text-center">Please scan the QR code in your authenticator apps,<br />then enter the code below.</p>
                            ...
                            <p class="text-center">Please enter the 6 digits code.</p>
                        ...
                        <asp:View ID="emailOTPView" runat="server">
                            <img src="images/email.png" class="img-fluid mx-auto d-block mb-3" style="max-width: 150px; height: auto; padding-top: 30px;" />

                            <h1 class="text-center">Email OTP</h1>
                            <p class="text-center">Please enter the code from your email.</p>
