...
<head runat="server">
    <title>Create Client Admin Page</title>
  ...
  <div class="container mt-3 card p-3 mb-4" style="max-width: 500px;" >
    <form id="form1" runat="server" class="container mt-3 needs-validation" style="border-radius: 10px;">
        ...
        <h3 class="text-left">
            ...
            <asp:TextBox ID="txtPICName" runat="server" CssClass="form-control"></asp:TextBox>
            <br />

            <asp:Label ID="lblPICContactNumber" runat="server" Text="PIC Contact Number"></asp:Label>
            <asp:TextBox ID="txtPICContactNumber" runat="server" CssClass="form-control"></asp:TextBox>
            <br />
            
            <asp:Label ID="lblTotalNumberOfBOD" runat="server" Text="Total Number of BOD"></asp:Label>
            <asp:TextBox ID="txtTotalNumberOfBOD" runat="server" CssClass="form-control"></asp:TextBox>
            <br />
